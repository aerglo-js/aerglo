...
import { setLoggingLevel, open } from '../utils';
...
export default class Build extends Command {
	...
	static flags = {
		...
		page: flags.string({
			char: 'p',
			description:
				'incremental build of only specified pages within site root (./pages/<PAGE>)',
			multiple: true,
		}),
		partial: flags.string({
			char: 'q',
			description:
				'incremental build of only specified partials within site root (./partials/<PARTIAL>)',
			multiple: true,
		}),
